...
\section{Descrizione del progetto}
    ...
    \include{capitoli/Premessa/Premessa}
    \include{capitoli/Documento dei requisiti software/Requisiti}
    \include{capitoli/Documento dei requisiti software/UseCaseDiagram}
    \include{capitoli/Documento dei requisiti software/TabelleCockburn}
    \include{capitoli/Documento dei requisiti software/Mockup}
    \include{capitoli/Documento dei requisiti software/Valutazione usabilità/Usabilità a priori.tex}
    \include{capitoli/Documento dei requisiti software/Target utenti/Target utenti.tex}
    \include{capitoli/Documento dei requisiti software/Glossario/Glossario.tex}
    \include{capitoli/Documento dei requisiti software/Classi di analisi.tex}
    \include{capitoli/Documento dei requisiti software/Sequence di analisi.tex}
    \include{capitoli/Documento dei requisiti software/State Diagram.tex}
    \include{capitoli/Documento di design/Architettura.tex}
    \include{capitoli/Documento di design/Sequence Design.tex}
    \include{capitoli/Documento di design/Classi di design.tex}
    \include{capitoli/Testing e Usabilità/Testing}
    \include{capitoli/Testing e Usabilità/Usabilità sul campo}
