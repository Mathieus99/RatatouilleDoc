...
\section{Descrizione del progetto}
    ...
    {\large I dipendenti quali camerieri, operatori di cucina, chef, capisala, saranno dotati di smartphone aziendali sempre con OS Android correttamente configurati per un'ottimale fruizione dell'applicazione.}
      \vspace{1cm}

    {\large \textbf{Tutti i dispositivi dovranno essere in grado di accedere a internet, preferibilmente per tutta la durata del servizio.}}
    \end{flushleft}
    ...
    \include{capitoli/Documento dei requisiti software/Tabelle di Cockburn}
