    ...
    \subsection{Requisiti Funzionali}
        ...
        \begin{center}
          ...
          \begin{tblr}{hlines = {0.9pt}, vlines = {0.9pt}, row{1} = {pink!60}, colspec = {X[c]X[l]}, width = \textwidth}
                  ...
                  \textbf{Descrizione} & {Il sistema permette ad un amministratore di creare utenze per i dipendenti non registrati del ristorante,\\ specificandone \textit{nome}, \textit{cognome}, \textit{email} e \textit{ruolo},\\ inviandogli per email le credenziali di accesso (Username e Password generata automaticamente)}
          \end{tblr}
