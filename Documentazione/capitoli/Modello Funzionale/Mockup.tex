    ...
    \subsubsection{Homepage dell'applicazione}
        ...
        \textbf{Componenti}:
            ...
            \begin{center}
                ...
                Bottone    &   PROFILO    &   Quando cliccato porta alla schermata \textit{\textbf{M0bho}} \\
                Bottone    &   ESCI       &   Quando cliccato mostra la schermata \textit{\textbf{M0bho}} \\
        ...
        \textbf{Componenti}:
          ...
          \begin{center}
            \begin{tblr}{hlines = {0.9pt}, vlines = {0.9pt}, row{1} = {marroneApp!60}, colspec = {X[c]X[c]X[c]}, width = \textwidth}
              ...
              Bottone   &   CREA AVVISO   &   Quando cliccato mostra la schermata \textit{\textbf{M0bho}} \\  
            \end{tblr}
          \end{center}
                    ...
                    \subsubsection{Schermata di aggiunta piatti al menù}
                        ...
                        \begin{center}
                          \begin{longtblr}{hlines = {0.9pt}, vlines = {0.9pt}, row{1} = {marroneApp!60}, colspec = {X[c]X[c]X[c]}, width = \textwidth, rowhead=1}
                            ...
                            Bottone         &   OK              &   Quando cliccato, ritorna alla schermata \textit{\textbf{M}} salvando nel menu il prodotto \\
                            Bottone         &   ANNULLA         &   Quando cliccate, ritorna alla schermata \textit{\textbf{M}} senza salvare il prodotto \\  
